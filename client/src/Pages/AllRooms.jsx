...
const AllRooms = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-18 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      {/* ✅ Right: Filters */}
      <div className="bg-white w-full lg:w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:ml-8">
        ...
        <div
          className={`${
            openFilter ? "h-auto" : "h-0"
          } lg:h-auto overflow-hidden lg:overflow-visible transition-all duration-700`}
        >
