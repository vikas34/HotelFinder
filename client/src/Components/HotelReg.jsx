        ...
        <form action="" className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <div className='w-full mt-4'>
                    ...
                    <input type="text" id='name' placeholder='Type here' required className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light *:'  />
                 ...
                 <div className='w-full mt-4'>
                    ...
                    <input type="text" id='contact' placeholder='Type here' required className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light *:'  />
                ...
                {/*Address*/}
                 ...
                 <div className='w-full mt-4'>
                  ...
                  Address
                    ...
                    <input type="text" id='address' placeholder='Type here' required className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light *:'  />
